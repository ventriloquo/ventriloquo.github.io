...
integrada ao Emacs e que tem funcionalidades que giram entorno de fazer parte de
um editor de texto. Resumindo:
...
_[S-Expressions](https://en.wikipedia.org/wiki/S-expression)_, o que faz com que
uma declaração que seria escrita assim em C:
